        ...
        <div className="relative w-full min-h-screen flex flex-col bg-white dark:bg-black text-black dark:text-white bg-cover bg-center p-6 transition-colors duration-500">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-20 px-4">
                ...
                <div className="md:w-1/2 space-y-4">
                    ...
                    <p className="text-slate-900 dark:text-white">
                        I'm Minh Qui, a young and passionate Front-End Developer with a strong interest in modern web technologies. After graduating with a degree in Information Technology, I decided to focus on front-end development, especially building clean, responsive interfaces.

                    </p>
                    <p className="text-slate-900 dark:text-white">
                        In addition to my academic background, I actively self-learned tools like ReactJS, TailwindCSS, and Figma to support my development workflow. Currently, I also work as a freelancer, creating websites for individuals and small businesses. I enjoy transforming designs into real, interactive web experiences that are accessible, fast, and user-friendly across all devices.
                    </p>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-8 mt-1 px-4">
                ...
                <div className="md:w-1/2 space-y-4">
                    ...
                    <p className="text-slate-900 dark:text-white">I had the opportunity to intern at VNPower Technology Co., Ltd., where I worked on real production-level projects as a Front-End Intern. My responsibilities included developing interfaces from Figma designs using ReactJS and TailwindCSS, as well as integrating APIs to dynamically render backend data.</p>
                    <p className="text-slate-900 dark:text-white">One of the key projects I contributed to was the development of a warehouse management web application. This system allowed users to manage inventory, track incoming and outgoing goods, and view detailed reports. I built core UI components such as the product list, category filters, and dashboard charts, and collaborated closely with back-end developers to ensure smooth API integration and real-time updates.</p>
                    <p className="text-slate-900 dark:text-white">Through this experience, I improved my technical skills and gained insights into how software products are built and delivered in real-world team environments.</p>
                </div>
            </div>
        </div>
    );
